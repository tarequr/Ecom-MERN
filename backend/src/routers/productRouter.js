...
const { handleCreateProduct, handleGetProduct, handleSingleProduct, handleDeleteProduct, handleUpdateProduct } = require('../controllers/productController');
...
// #4 - Update Product
router.put('/:slug', uploadProductImage.single("image"), isLoggedIn, isAdmin, handleUpdateProduct);
// #5 - Delete Product
